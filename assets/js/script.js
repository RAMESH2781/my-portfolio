...
if (form) {
  form.addEventListener("submit", function (e) {
    ...
    .then(data => {
      // FormSubmit returns data.success as true (boolean) or string "true" depending on status
      if (data.success === true || data.success === "true" || response.ok) {
        ...
        formBtn.style.background = "linear-gradient(to right, #26a641, #39d353)";
    ...
    .catch(error => {
      ...
      formBtn.innerHTML = "<ion-icon name='alert-circle-outline'></ion-icon><span>Activation Sent!</span>";
      formBtn.style.background = "var(--text-gradient-yellow)";
